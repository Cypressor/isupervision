package com.cypress.isupervision.views.administratoren;
...
@Route(value = "administratoren/:assistentID?/:action?(edit)", layout = MainLayout.class)
@RolesAllowed("ADMIN")
public class AdministratorenView extends Div implements BeforeEnterObserver {

    private final String ASSISTENT_ID = "assistentID";
    private final String ASSISTENT_EDIT_ROUTE_TEMPLATE = "administratoren/%s/edit";
    ...
    @Autowired
    public AdministratorenView(AssistentService assistentService) {
        this.assistentService = assistentService;
        addClassNames("administratoren-view");
        ...
        grid.asSingleSelect().addValueChangeListener(event -> {
            if (event.getValue() != null) {
                ...
                clearForm();
                UI.getCurrent().navigate(AdministratorenView.class);
            }
        });
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (assistentId.isPresent()) {
            ...
            if (assistentFromBackend.isPresent()) {
                ...
                // refresh grid
                refreshGrid();
                event.forwardTo(AdministratorenView.class);
            }
        }
    }
