...
@Route(value = "meineprojekte/:masterarbeitID?/:action?(edit)", layout = MainLayout.class)
@PermitAll
public class MeineProjekteView extends Div implements BeforeEnterObserver {
    ...
    private final String MASTERARBEIT_EDIT_ROUTE_TEMPLATE = "meineprojekte/%s/edit";
    ...
    @Autowired
    public MeineProjekteView(MasterarbeitService masterarbeitService) {
